...
class TestRunner(unittest.TestCase):
    ...
    @patch("src.core.runner.scan_ips", return_value=[
        ("host1", "192.168.1.1", "Active", 12)
    ])
    ...
    @patch("src.core.runner.async_scan_ips", return_value=[
        ("host2", "192.168.1.2", "Active", 15)
    ])
    ...
    @patch("src.core.runner.scan_ips", return_value=[
        ("host4", "192.168.1.4", "Inactive", None)
    ])
